...
public enum Rank {
    ...
    BASIC("Basic", "&7[&8Basic&7] ", CC.DARK_GRAY),
    SILVER("Silver", "&7[Silver&7] ", CC.GRAY),
    ...
    MOD("Mod", "&7[&3Mod&7] ", CC.AQUA),
    SENIORMOD("SeniorMod", "&7[&3&oSenior Mod&7] ", CC.I_AQUA),
    ...
    public static void importRanks() {
        ...
        ConsoleUtils.log(Color.translate("&b[Facebook] &eImported ranks&7: &4Owner&e, &4&oManager&e, &cAdmin&7, &3&oSenior Mod&e, &3Mod&e, &e&oTrial Mod&e, &dRuby&e, &9Platinum&e, &6Gold&e, &7Silver&e, &bBasic&e, &aDefault&e."));
    }
}
