...
public enum NormalPrefixType {
    ...
    NormalPrefixType(String name, String style, String... description) {
        this.name = name;
        this.style = StringEscapeUtils.unescapeJava(style); //radilo je ali vidis da me jebe intel ja stavim utf on ga vrati jebo mu ja boga
