...
public class ListCommand extends BaseCommand {
    ...
    public void execute(Player player, String[] args) {
        ...
        player.sendMessage(Color.translate("&4Owner&e, &4&oManager&e, &cAdmin&7, &3&oSenior Mod&e, &3Mod&e, &e&oTrial Mod&e, &6Famous&e, &5YouTuber&e, &d&oMedia&e, &dRuby&e, &9Platinum&e, &6Gold&e, &7Silver&e, &bBasic&e, &aDefault&e."));
        player.sendMessage("");
