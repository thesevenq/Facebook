      ...
      (new BukkitRunnable() {
         ...
         public void run() {
            ...
            for(double d1 = 0.0D; d1 <= 6.283185307179586D; d1 += 0.09817477042468103D) {
               ...
               double d3 = 2.0D * Math.exp(-0.1D * this.amount) * Math.sin(this.amount) + 1.5D;
               double d4 = this.amount * Math.sin(d1);
               this.location.add(d2, d3, d4);
               ParticleEffect.FIREWORKS_SPARK.display(0.0F, 0.0F, 0.0F, 0.0F, 1, this.location, 100.0D);
               this.location.subtract(d2, d3, d4);
               d2 = this.amount * Math.cos(d1 += 0.04908738521234052D);
               d3 = 2.0D * Math.exp(-0.1D * this.amount) * Math.sin(this.amount) + 1.5D;
               d4 = this.amount * Math.sin(d1);
               this.location.add(d2, d3, d4);
               ParticleEffect.FLAME.display(0.0F, 0.0F, 0.0F, 0.0F, 1, this.location, 100.0D);
               this.location.subtract(d2, d3, d4);
            }
