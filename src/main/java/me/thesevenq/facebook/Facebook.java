...
public class Facebook extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        if (Facebook.getInstance().getConfig().getBoolean("ANNOUNCE_SERVER_STATUS")) Bukkit.getScheduler().runTaskLater(this, () -> DatabaseManager.getInstance().getPublisher().write(JedisPublisher.GLOBAL, "serverstart"), 20L * 3);
